...
var printpdfpageobject = function(pagenum){
    ...
    this.renderPDFpage = function(){
        ...
        pdfDoc.getPage(thispage.pagenum+1).then(function(page) {
            ...
            //thispage.PDFpageRotate = page.pageInfo.rotate;
...
//replace with svg div
    ...
    if(opener.RxCore.printhelper().documentcompare){
        ...
        if(opener.RxCore.printhelper().docObj != null){
          ...
          //DocPrintObj(opener.RxCore.printhelper().docObj,PaperWidth,PaperHeight);
          var paperobj = {
            width : PaperWidth,
            height : PaperHeight  
          };
          ...
          var pwidth = paperobj.width + "mm";
          var pheight = paperobj.height + "mm";


          var canvashireswidth = (paperobj.width / 25.4)* 300;
          var canvashiresheight = (paperobj.height / 25.4)* 300;

          var sizemmwidth = paperobj.width + 'mm';
          var sizemmheight = paperobj.height + 'mm';
          var stylepsize = "size: " + sizemmwidth + " " + sizemmheight;
          var stylemargin = " margin: 0mm";

          var css = '@page { ' +  stylepsize + ';' + stylemargin + ';' +  '}';
          ...
          //canvaso.style.width = pwidth + "px";
          //canvaso.style.height = pheight + "px";
          canvaso.style.width = pwidth;
          canvaso.style.height = pheight;

          //canvaso.style.pageBreakBefore = "";
          //canvaso.style.pageBreakAfter = "";
          ...
          for(var i = 0; i < numpages; i++){
                if (i > 0){
                  ...
                  //canvpage.style.pageBreakBefore = "";
                  //canvpage.style.pageBreakAfter = "";
          ...
          if (opener.RxCore.printhelper().docObj.pdfDoc != null){
            ...
            PDFJS.getDocument(opener.RxCore.printhelper().docObj.pdfURL).then(function (pdfDoc_) {
                  pdfDoc = pdfDoc_; 
...
>>>>>>> 3152f1b7b89a33ca1391a3c149eb2db76736f035
